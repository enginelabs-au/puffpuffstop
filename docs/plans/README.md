...
Plans are generated and executed sequentially.

1. `phase_0_foundations_plan.md` maps the full project and implements foundations.
...
Current: phases 0–10 verified locally. Phase 11 is voice log. Phase 12 (health wearables) is planned, not started. Closure list is `final_implementation_checklist.md`.
